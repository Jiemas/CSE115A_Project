...
export const callBackend = async (method: string, pathExtension: string, accessToken='', requestBody={}, contentType='application/json') => {
  const headerObject = {
  ...
  if (JSON.stringify(requestBody) != '{}') {
    fetchObject['body'] = contentType == 'application/json' ? JSON.stringify(requestBody) : requestBody;
  }
